...
<body>
    ...
    <img id="mobile-img" src="<?php echo 'images/triathlon-swim-04.jpg'; ?>">
    ...
    <div class="slideshow-container">
        ...
        <div class="mySlides fade">
            <img src="<?php echo 'images/triathlon-run-01.jpg'; ?>">
        </div>

        <div class="mySlides fade">
            <img src="<?php echo 'images/triathlon-run-02.jpg'; ?>">
        </div>

        <div class="mySlides fade">
            <img src="<?php echo 'images/triathlon-swim-01.jpg'; ?>">
        </div>
